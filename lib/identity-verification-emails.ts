          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                <tr>
                  <td align="center">
                    <a href="https://panico.app/dashboard" style="display: inline-block; padding: 16px 32px; background: linear-gradient(135deg, #2563eb 0%, #7c3aed 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">
                      Vai alla Dashboard
                    </a>
                  </td>
                </tr>
...
Vai alla dashboard: https://panico.app/dashboard
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                <tr>
                  <td align="center">
                    <a href="https://panico.app/verifica-identita" style="display: inline-block; padding: 16px 32px; background: linear-gradient(135deg, #2563eb 0%, #7c3aed 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">
                      Riprova Verifica
                    </a>
                  </td>
                </tr>
...
Puoi inviare una nuova richiesta: https://panico.app/verifica-identita
